    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API for notification management and delivery")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("MergeEats Team")
                ...
                .addTagsItem(new Tag().name("Notification").description("Notification management operations"))
                .addTagsItem(new Tag().name("Delivery").description("Notification delivery operations"))
